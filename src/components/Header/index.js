            ...
            {context.isLogin !== true ? (
              ...
              <div className="MyAccountWrapper">
                ...
                >
                  <div className="userImg">
                    <span className="rounded-circle">
                      <img
                        src="https://imgs.search.brave.com/WIWYbvkdLpvLCyharr7pOae44bK0kp5PNspkVe4cehI/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/bXVzaWNjYWZlbmVw/YWwuY29tL2ltYWdl/cy9hcnRpc3RzL25h/cmF5YW4uSlBH"
                        alt="businessmanlogo"
                      />
                    </span>
                  </div>
                ...
                <Menu
                  anchorEl={anchorEl}
                  id="account-menu"
                  open={open} // Correctly use the open state
